      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <a href="https://github.com/prashiyn/plc-copilot" target="_blank" rel="noopener noreferrer" aria-label="PLCAutoPilot on GitHub" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="pt-8 border-t border-gray-800 text-center text-gray-400 text-sm space-y-2">
          ...
          <p className="text-xs text-gray-500 mt-4">
            ...
            <a href="https://github.com/prashiyn/plc-copilot" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 ml-1">
              github.com/prashiyn/plc-copilot
            </a>
          </p>
        </div>
      </div>
